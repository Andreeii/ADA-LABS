...
namespace ADA_LAB1
{
    class Program
    {
        const string INPUT_FILE = @"C:\Users\Andrei Turcanu\Desktop\ADA-LABS\ADA-LAB1\input.txt";
        const string OUTPUT_FILE = @"C:\Users\Andrei Turcanu\Desktop\ADA-LABS\ADA-LAB1\output-tpl.txt";

...
namespace EventSource
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            File.WriteAllText(@"C:\Users\Andrei Turcanu\Desktop\ADA-LABS\ADA-LAB3\EventSource\events.json", json);

            using (var file = File.Create(@"C:\Users\Andrei Turcanu\Desktop\ADA-LABS\ADA-LAB3\EventSource\events.proto"))
            {

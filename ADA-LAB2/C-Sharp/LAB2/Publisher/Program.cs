...
namespace ConsoleApp1
{
    class Program
    {
        const string INPUT_FILE = @"C:\Users\Andrei Turcanu\Desktop\ADA-LABS\ADA-LAB2\input.txt";
        const string OUTPUT_FILE = @"C:\Users\Andrei Turcanu\Desktop\ADA-LABS\ADA-LAB2\output.txt";
